...
const SYSTEM_PROMPT = `أنت "مساعد منصة علم الذكي"، صديق الطالب ورفيقه في منصة منصة عِلم التعليمية واللغة العربية.
